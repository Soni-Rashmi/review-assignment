  ...
  <div className="container-fluid">
    <div className="row">
      <div className="col-sm-12 sponsered-card card">
        ...
        <img src={YELLOW_BUILDING_IMG} alt="Building" className="yellow-building"/>
      ...
      <div className="col-sm-12 likes-card card">
        ...
        <div className="media">
          ...
          <div className="media-body">
            ...
            <Button className="btn btn-default" bsSize="small"><i className="fa fa-user-plus"></i>Follow </Button>
          </div>
        </div>
        <div className="media">
          <div className="media-left">
